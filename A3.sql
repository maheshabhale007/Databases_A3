...
INSERT INTO requestDetails (Sr_No, Apply_for, Applied_on, Name, Status, Query) VALUES
(1, 'trainer', '2023-03-31', 'John Smith', 'Pending', 'SELECT * FROM users'),
(2, 'volunteer', '2023-03-31', 'Jane Doe', 'Completed', 'INSERT INTO events (title, date) VALUES ("Charity Walk", "2023-04-15")'),
(3, 'trainer', '2023-04-01', 'Michael Johnson', 'Pending', 'UPDATE inventory SET quantity = quantity - 10 WHERE item_id = 5'),
(4, 'volunteer', '2023-04-01', 'Jessica Lee', 'Completed', 'DELETE FROM tasks WHERE task_id = 15'),
(5, 'trainer', '2023-04-02', 'David Williams', 'Pending', 'SELECT COUNT(*) FROM orders WHERE order_date >= "2023-01-01"'),
(6, 'volunteer', '2023-04-02', 'Emily Chen', 'Completed', 'INSERT INTO donations (donor_name, amount) VALUES ("Mark Johnson", 500)'),
(7, 'trainer', '2023-04-03', 'Oliver Taylor', 'Pending', 'UPDATE customers SET last_order_date = "2023-04-03" WHERE customer_id = 25'),
(8, 'volunteer', '2023-04-03', 'Grace Kim', 'Completed', 'SELECT product_name, price FROM products WHERE category = "Electronics"'),
(9, 'trainer', '2023-04-04', 'Sophia Lee', 'Pending', 'SELECT COUNT(*) FROM users WHERE registration_date >= "2023-01-01"'),
(10, 'volunteer', '2023-04-04', 'Daniel Wilson', 'Completed', 'INSERT INTO contacts (name, email, phone) VALUES ("Karen Lee", "karen.lee@gmail.com", "123-456-7890")'),
(11, 'trainer', '2023-04-05', 'Emma Davis', 'Pending', 'UPDATE employees SET salary = salary * 1.05 WHERE department = "Sales"'),
(12, 'volunteer', '2023-04-05', 'Lucas Brown', 'Completed', 'DELETE FROM customers WHERE customer_id = 50'),
(13, 'trainer', '2023-04-06', 'Ava Taylor', 'Pending', 'SELECT order_id, total_amount FROM orders WHERE order_date >= "2023-03-01"'),
(14, 'volunteer', '2023-04-06', 'Liam Wilson', 'Completed', 'INSERT INTO reviews (product_id, rating, review_text) VALUES (10, 4.5, "Great product, highly recommended")'),
(15, 'trainer', '2023-04-07', 'Mia Clark', 'Pending', 'UPDATE products SET price = price * 0.9 WHERE category = "Clothing"')
;
